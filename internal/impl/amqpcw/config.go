...
const (
	...
	// CW customer fields
	accountHeaderField            = "account"
	dedicatedHeaderField          = "dedicated"
	eventHeaderField              = "event"
	integrationHeaderField        = "integration"
	integrationConnectHeaderField = "integration_connect"
	serializerHeaderField         = "serializer"
